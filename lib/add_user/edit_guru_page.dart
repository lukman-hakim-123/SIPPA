...
class EditGuruPage extends ConsumerStatefulWidget {
  final User user;
  static route(User user) =>
      MaterialPageRoute(builder: (context) => EditGuruPage(user: user));
  const EditGuruPage({super.key, required this.user});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _EditGuruPageState();
}

class _EditGuruPageState extends ConsumerState<EditGuruPage> {
