                    ...
                    Expanded(
                      child: rubrikState.when(
                        data: (rubrikList) {
                          ...
                          final filtered = rubrikList.where((rubrik) {
                            final muridName =
                                muridMap[rubrik.muridId]?.id.toLowerCase() ??
                                '';
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  ...
                                  leading: CircleAvatar(
                                    ...
                                    child: ClipOval(
                                      child:
                                          muridMap[rubrik.muridId]?.imageId !=
                                                  null &&
                                  ...
                                  subtitle: Column(
                                    ...
                                    children: [
                                      CustomText(
                                        text: 'kelas: ${rubrik.kelompok}',
                                      ),
                                      CustomText(text: rubrik.tanggal),
                                    ],
                                  ),
  ...
  Future<void> _deleteRubrik(
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        title: CustomText(text: 'Hapus Rubrik'),
        content: CustomText(
    ...
    if (confirm == true) {
      ref.read(rubrikProvider.notifier).deleteRubrik(rubrik);
