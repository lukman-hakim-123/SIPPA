...
class MuridScreen extends ConsumerStatefulWidget {
  const MuridScreen({super.key});

  @override
  ConsumerState<MuridScreen> createState() => _MuridScreenState();
}

class _MuridScreenState extends ConsumerState<MuridScreen> {
                      ...
                      child: muridState.when(
                        data: (muridList) {
                          ...
                          final filtered = muridList.where((murid) {
                            return murid.nama.toLowerCase().contains(
                              searchQuery,
                            );
                          }).toList();
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: userLevel != 3
                                      ...
                                      : null,
                                  onTap: () =>
                                      context.go('/detailMurid', extra: murid),
                                ),
                              );
                            },
                          );
  ...
  Future<void> _deletemurid(
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        title: CustomText(text: 'Hapus murid'),
        content: CustomText(
    ...
    if (confirm == true) {
      ref.read(muridProvider.notifier).deleteMurid(murid);
