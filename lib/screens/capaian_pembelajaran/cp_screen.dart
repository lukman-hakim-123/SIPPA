                      ...
                      child: cpState.when(
                        data: (cpList) {
                          ...
                          final filtered = cpList.where((cp) {
                            final muridName =
                                muridMap[cp.muridId]?.id.toLowerCase() ?? '';
  ...
  Future<void> _deleteCp(
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        title: CustomText(text: 'Hapus Capaian Pembelajaran'),
        content: CustomText(
          text: 'Apakah Anda yakin ingin menghapus Capaian Pembelajaran ini?',
        ),
        actions: [
          TextButton(
    ...
    if (confirm == true) {
      ref.read(cpProvider.notifier).deleteCp(cp);
