...
class _RubrikPageState extends ConsumerState<RubrikPage> {
  ...
  Future<void> _refreshData() async {
    ...
    await ref.refresh(rubrikControllerProvider);
    ...
    if (userDetails != null) {
      ...
      final newRubrikList =
          await ref.read(getRubrikByUserIdProvider(paramKey).future);
      setState(() {
        _rubrikList = newRubrikList;
        _filterRubrikList();
      });
    }
  }
        ...
        child: userDetailsAsync.when(
          data: (userDetails) {
            ...
            final rubrikAsyncValue =
                ref.watch(getRubrikByUserIdProvider(paramKey));
                              ...
                              child: DataTable(
                                ...
                                rows: _filteredRubrikList
                                  ...
                                  final muridData = ref.watch(
                                      getUserDataProvider(rubrik.muridId));
                                  return DataRow(
                                    cells: [
                                      DataCell(
                                        ConstrainedBox(
            ...
            if (error.toString().contains('Failed host lookup')) {
              return ReloadError(
                onReload: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => const RubrikPage()),
                  );
                },
              );
            }
